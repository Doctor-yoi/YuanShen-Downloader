// @author 逍遥子k
// @url https://www.cnblogs.com/xyz0835/p/5056464.html
...
namespace YS_Downloader.Utils
{
    ...
    {
        // Wrapped dialog
        Microsoft.Win32.OpenFileDialog ofd = null;
        ...
        public bool ShowDialog(IntPtr hWndOwner)
        {
            ...
            if (Environment.OSVersion.Version.Major >= 6)
            {
                ...
                uint options = (uint)r.CallAs(typeof(Microsoft.Win32.FileDialog), ofd, "GetOptions");
